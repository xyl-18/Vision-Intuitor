...
@register_adv_estimator(AdvantageEstimator.INTUITOR)
def compute_intuitor_outcome_advantage(
    token_level_rewards: torch.Tensor,
    response_mask: torch.Tensor,
    index: torch.Tensor,
    intuitor_internal_token_level_scores: torch.Tensor,
    intuitor_format_token_level_scores: torch.Tensor | None = None,
    intuitor_external_token_level_scores: torch.Tensor | None = None,
    intuitor_length_token_level_scores: torch.Tensor | None = None,
    ...
    **kwargs,
    ...
    """Compute Intuitor-style outcome advantage from internal self-certainty.
    ...
    for component_token_level_scores, component_weight in component_specs:
        ...
        combined_advantages = combined_advantages + component_weight * component_advantages

    returns = combined_advantages
