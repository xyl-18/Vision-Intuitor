...
SECOND_INTERNAL_WEIGHT=${SECOND_INTERNAL_WEIGHT:-0.9}
SECOND_FORMAT_WEIGHT=${SECOND_FORMAT_WEIGHT:-0.1}
SECOND_EXTERNAL_WEIGHT=${SECOND_EXTERNAL_WEIGHT:-0.0}
SECOND_LENGTH_WEIGHT=${SECOND_LENGTH_WEIGHT:-0.0}
SECOND_EXTERNAL_KEY=${SECOND_EXTERNAL_KEY:-description_accuracy}

INTUITOR_REWARD_METHOD=${INTUITOR_REWARD_METHOD:-entropy} # supported methods: self_certainty, entropy
...
python3 -m vision_intuitor_sr1_lora.main \
    ...
    trainer.experiment_name=v1.7_qwen2_5_vl_3b_visionIntuitor_sr1_lora \
    trainer.save_checkpoint_path=./saves/v1.7_v1_3b_intuitor_sr1_lora \
