"""Vision-Intuitor-SR1 training entry point (LoRA variant)."""
...
from vision_sr1_lora.data_loader import create_dataloader

from .ray_trainer import IntuitorSR1Trainer
from .reward_manager import SelfRewardManager


@ray.remote(num_cpus=1)
class Runner:
    """Runner for Vision-Intuitor-SR1 RL training."""
