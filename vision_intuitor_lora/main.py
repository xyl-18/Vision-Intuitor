"""
Vision-Intuitor (RLIF) training entry point (LoRA variant).

This experiment entry keeps the same training stack as Vision-R1 LoRA,
while switching internal optimization via algorithm.adv_estimator=intuitor.
"""
...
from vision_r1_lora.data_loader import create_dataloader


@ray.remote(num_cpus=1)
class Runner:
    """Runner for Vision-Intuitor RL training."""
